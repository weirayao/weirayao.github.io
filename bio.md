...
Previously he led the post-training team at Salesforce AI Research. There he shipped xLAM, a family of state-of-the-art function-calling models, the synthetic data pipelines behind APIGen, APIGen-MT, and AgentOhana, and Retroformer, a generative critic model for agent self-reflection. He also built agentic systems including CodeGenie Agent, SlackAgents, Ensemble Agents, and Salesforce WebAgent, along with automatic root cause analysis for SRE/AIOps.

He did his PhD and MS in Machine Learning at CMU, focused on model interpretability, where he was advised by Kun Zhang.
